  ...
  criteria: [
    ...
    },
    {
      ...
      levels: [
        ...
        { label: "성장", description: "직접 만든 MIDI나 녹음이 포함된다." },
...
const drumMissions: Mission[] = [
  {
    ...
    hint: "왼쪽 Library의 Drums 루프를 Beat 트랙으로 드래그하면 빠르게 시작할 수 있어요.",
...
const bassMissions: Mission[] = [
  {
    ...
    hint: "Bass 카테고리의 루프를 사용하거나 MIDI Clip으로 직접 만들 수 있어요.",
  ...
  },
  {
    ...
    hint: "두 트랙 모두 Mute가 꺼져 있는지 확인하세요.",
...
const melodyMissions: Mission[] = [
  {
    id: "melody-notes",
    title: "멜로디 노트 6개 입력",
    description: "멜로디 역할 MIDI 클립에 노트 6개 이상을 입력하세요.",
    hint: "MIDI Clip을 선택하면 아래 Piano Roll에서 노트를 추가할 수 있어요.",
...
const structureMissions: Mission[] = [
  ...
  },
  {
    ...
    hint: "9마디 이후에 다른 루프나 MIDI 아이디어를 추가해보세요.",
...
const recordingMissions: Mission[] = [
  {
    ...
    hint: "마이크 녹음 기능이 추가되면 목소리, 박수, 악기 소리를 녹음해 배치하세요.",
  ...
  },
  {
    ...
    hint: "녹음 소리가 너무 크면 Mixer에서 볼륨을 낮춰보세요.",
...
export const LESSONS: Lesson[] = [
  {
    ...
    difficulty: "starter",
    estimatedMinutes: 12,
    templateProject: project("lesson-drum-template", "Lesson 1 - Drum Foundation", 120, [
      track("lesson-drum-beat", "Beat", "drum", "beat", "#38bdf8"),
      track("lesson-drum-bass", "Bass", "instrument", "bass", "#f59e0b")
    ]),
  ...
  },
  {
    ...
    difficulty: "starter",
    estimatedMinutes: 15,
    templateProject: project("lesson-bass-template", "Lesson 2 - Bass Layer", 116, [
      track("lesson-bass-beat", "Beat", "drum", "beat", "#38bdf8", [
        clip("lesson-bass-drum-loop", "lesson-bass-beat", "Locked Drum Guide", "drums-grid", "#38bdf8", 0, 32, true, "이 비트는 기준 반주입니다.")
      ]),
      track("lesson-bass-track", "Bass", "instrument", "bass", "#f59e0b")
    ]),
  ...
  },
  {
    ...
    difficulty: "builder",
    estimatedMinutes: 18,
    templateProject: project("lesson-melody-template", "Lesson 3 - Melody Sketch", 110, [
      track("lesson-melody-beat", "Beat", "drum", "beat", "#38bdf8", [
        clip("lesson-melody-drum-loop", "lesson-melody-beat", "Soft Beat Guide", "drums-electro", "#22c55e", 0, 32, true)
      ]),
      track("lesson-melody-bass", "Bass", "instrument", "bass", "#f59e0b", [
        clip("lesson-melody-bass-loop", "lesson-melody-bass", "Bass Guide", "bass-clean", "#fb7185", 0, 32, true)
      ]),
      track("lesson-melody-track", "Melody", "instrument", "melody", "#a78bfa", [
        midiClip("lesson-melody-empty", "lesson-melody-track", "My Melody", "#a78bfa", 0)
      ])
    ]),
  ...
  },
  {
    ...
    difficulty: "builder",
    estimatedMinutes: 22,
    templateProject: project("lesson-structure-template", "Lesson 4 - A/B Structure", 122, [
      track("lesson-structure-beat", "Beat", "drum", "beat", "#38bdf8", [
        clip("lesson-structure-a-beat", "lesson-structure-beat", "A Beat", "drums-grid", "#38bdf8", 0, 32, true)
      ]),
      track("lesson-structure-bass", "Bass", "instrument", "bass", "#f59e0b", [
        clip("lesson-structure-a-bass", "lesson-structure-bass", "A Bass", "bass-midnight", "#f59e0b", 0, 32, true)
      ]),
      track("lesson-structure-melody", "Melody", "instrument", "melody", "#a78bfa")
    ]),
  ...
  },
  {
    ...
    estimatedMinutes: 25,
    templateProject: project("lesson-recording-template", "Lesson 5 - Recording Layer", 100, [
      track("lesson-recording-beat", "Beat", "drum", "beat", "#38bdf8", [
        clip("lesson-recording-drum-loop", "lesson-recording-beat", "Beat Guide", "drums-grid", "#38bdf8", 0, 32, true)
      ]),
      track("lesson-recording-audio", "Recording", "audio", "recording", "#4ade80")
    ]),
