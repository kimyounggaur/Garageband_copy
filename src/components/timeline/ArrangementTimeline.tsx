...
export function ArrangementTimeline() {
  ...
  return (
    <section className="panel grid min-h-0 grid-rows-[44px_minmax(0,1fr)] rounded-lg">
      ...
      <div className="grid min-h-0 grid-cols-[178px_minmax(0,1fr)]">
        ...
        <div className="min-w-0 overflow-auto bg-studio-950/80">
